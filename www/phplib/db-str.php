...
$STR_MESSAGES = array(
  ...
  "Old STR" =>
     ...
     ."submit a new STR with updated information.",
  "Unresolvable" =>
...
class str
{
  ...
  delete()
  {
    ...
    db_query("DELETE FROM strfile WHERE str_id=$this->id");
    db_query("DELETE FROM strtext WHERE str_id=$this->id");
    $this->clear();
  }
...
//    print("<p>mysql_error is \"" . mysql_error() . "\"...</p>\n");
  ...
  {
    global $LOGIN_LEVEL, $STR_SUBSYSTEMS;
