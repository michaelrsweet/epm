...
//   auth_write_file() - Write the authorization files for Apache.
//
...
{
  global $_COOKIE, $_SERVER, $LOGIN_EMAIL, $LOGIN_LEVEL, $LOGIN_USER,
         $PROJECT_LOGIN, $PROJECT_MODULE, $LOGIN_ID;
...
auth_write_file()
{
  ...
  if (db_count($result) > 0)
  {
    while ($row = db_next($result))
      fwrite($passwd, "$row[name]:$row[hash]\n");
  }
